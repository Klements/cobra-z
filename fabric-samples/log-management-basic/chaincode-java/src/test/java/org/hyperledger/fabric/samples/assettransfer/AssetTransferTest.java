...
public final class AssetTransferTest {
    ...
    class InvokeReadAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Log log = contract.ReadLog(ctx, "asset1");

            assertThat(log).isEqualTo(new Log("asset1", "blue", 5, "Tomoko", 300));
        }
        ...
        public void whenAssetDoesNotExist() {
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.ReadLog(ctx, "asset1");
            });

            assertThat(thrown).isInstanceOf(ChaincodeException.class).hasNoCause()
                    .hasMessage("Log asset1 does not exist");
    ...
    class InvokeCreateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Throwable thrown = catchThrowable(() -> {
                contract.CreateLog(ctx, "asset1", "blue", 45, "Siobhán", 60);
            });

            assertThat(thrown).isInstanceOf(ChaincodeException.class).hasNoCause()
                    .hasMessage("Log asset1 already exists");
        ...
        public void whenAssetDoesNotExist() {
            ...
            Log log = contract.CreateLog(ctx, "asset1", "blue", 45, "Siobhán", 60);

            assertThat(log).isEqualTo(new Log("asset1", "blue", 45, "Siobhán", 60));
        }
    }
    ...
    void invokeGetAllAssetsTransaction() {
        ...
        String logs = contract.GetAllLogs(ctx);

        assertThat(logs).isEqualTo("[{\"appraisedValue\":300,\"assetID\":\"asset1\",\"color\":\"blue\",\"owner\":\"Tomoko\",\"size\":5},"
    ...
    class UpdateAssetTransaction {
        ...
        public void whenAssetExists() {
            ...
            Log log = contract.UpdateAsset(ctx, "asset1", "pink", 45, "Arturo", 600);

            assertThat(log).isEqualTo(new Log("asset1", "pink", 45, "Arturo", 600));
        }
